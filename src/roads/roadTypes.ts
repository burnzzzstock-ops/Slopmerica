...
export const ROAD_TYPES: Record<RoadTypeId, RoadType> = {
  gravel: mk({
    ...
    sidewalk: 0, speed: 11, costPerM: 3, upkeepPerM: 0.05, zoneable: true, signals: false, capacityPerLane: 500, fedGrant: 0, next: 'twoLane', unlockPop: 0, icon: '🪨',
  }),
  twoLane: mk({
    id: 'twoLane', name: 'Two-Lane Road', blurb: 'Sidewalks! How European.', lanesPerDir: 1, laneW: 3.5, centerTurn: false, median: 0,
    sidewalk: 2.6, speed: 14, costPerM: 8, upkeepPerM: 0.12, zoneable: true, signals: false, capacityPerLane: 800, fedGrant: 0, next: 'stroad4', unlockPop: 0, icon: '🛣️',
  }),
  stroad4: mk({
    ...
    sidewalk: 1.6, speed: 20, costPerM: 22, upkeepPerM: 0.35, zoneable: true, signals: true, capacityPerLane: 900, fedGrant: 0.5, next: 'stroad6', unlockPop: 0, icon: '🇺🇸',
  }),
  stroad6: mk({
    id: 'stroad6', name: 'MEGA Stroad', blurb: '6 lanes. It will fix traffic this time.', lanesPerDir: 3, laneW: 3.5, centerTurn: true, median: 0,
    sidewalk: 1.4, speed: 22, costPerM: 40, upkeepPerM: 0.6, zoneable: true, signals: true, capacityPerLane: 950, fedGrant: 0.8, next: 'stroad8', unlockPop: 600, icon: '🦅',
  }),
  stroad8: mk({
    ...
    sidewalk: 1.2, speed: 24, costPerM: 62, upkeepPerM: 0.9, zoneable: true, signals: true, capacityPerLane: 950, fedGrant: 0.8, unlockPop: 2500, icon: '🤠',
  }),
  highway: mk({
    ...
    sidewalk: 0, speed: 31, costPerM: 70, upkeepPerM: 1.2, zoneable: false, signals: false, capacityPerLane: 1900, fedGrant: 0.9, unlockPop: 1500, icon: '🚀',
  }),
};
